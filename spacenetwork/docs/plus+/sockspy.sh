...
echo -e "[Unit]
Description=$1 Service by @drowkid01
...
ExecStart=/usr/bin/$py /etc/spnw/$1.py $conf
Restart=always
RestartSec=3s
...
print_center -ama "$(fun_trans  "Instalador socks-py")"
msg -bar
echo -ne "$(msg -verd "  [1]") $(msg -verm2 ">") " && msg -azu "Simple      $P1"
echo -ne "$(msg -verd "  [2]") $(msg -verm2 ">") " && msg -azu "Seguro      $P2"
echo -ne "$(msg -verd "  [3]") $(msg -verm2 ">") " && msg -azu "Directo     $P3"
echo -ne "$(msg -verd "  [4]") $(msg -verm2 ">") " && msg -azu "OpenVPN     $P4"
echo -ne "$(msg -verd "  [5]") $(msg -verm2 ">") " && msg -azu "GETTUNEL    $P5"
msg -bar
